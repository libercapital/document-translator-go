...
type ResumoTransacional struct {
	...
	ValorBruto                         float64   `translator:"part:84..95;decimal:2"`            // Valor Bruto                           085..096 N(012)
	ValorLiquido                       float64   `translator:"part:96..107;decimal:2"`           // Valor Líquido                         097..108 N(012)
	ValorTarifa                        float64   `translator:"part:108..119;decimal:2"`          // Valor da Tarifa                       109..120 N(012)
	ValorTaxaDesconto                  float64   `translator:"part:120..131;decimal:2"`          // Valor da Taxa de Desconto             121..132 N(012)
	ValorRejeitado                     float64   `translator:"part:132..143;decimal:2"`          // Valor Rejeitado                       133..144 N(012)
	ValorCredito                       float64   `translator:"part:144..155;decimal:2"`          // Valor Crédito                         145..156 N(012)
	...
	ValorLiquidoCobranca               float64   `translator:"part:254..265;decimal:2"`          // Valor Líquido da Cobrança             255..266 N(012)
...
type AnaliticoTransacional struct {
	...
	ValorTransacao                     float64   `translator:"part:70..81;decimal:2"`            // Valor da Transação                    071..082 N(012)
	ValorSaque                         float64   `translator:"part:82..93;decimal:2"`            // Valor do Saque                        083..094 N(012)
	ValorTaxaEmbarque                  float64   `translator:"part:94..105;decimal:2"`           // Valor da Taxa de Embarque             095..106 N(012)
	...
	ValorParcela                       float64   `translator:"part:110..121;decimal:2"`          // Valor da Parcela                      111..122 N(012)
	...
	ValorComissaoVenda                 float64   `translator:"part:175..186;decimal:2"`          // Valor Comissão da Venda               176..187 N(012)
...
type AjusteFinanceiro struct {
	...
	ValorAjuste                    float64   `translator:"part:63..74;decimal:2"`            // Valor do Ajuste                      064..075 N(012)
	...
	ValorComissaoVendaCancelada    float64   `translator:"part:154..165;decimal:2"`          // Valor da Comissão da Venda Cancelada 155..166 N(012)
...
type ResumoFinanceiro struct {
	...
	ValorBrutoOperacaoAdquirencia        float64   `translator:"part:66..77;decimal:2"`          // Valor Bruto da Operação - Adquirência 067..078 N(012)
	ValorCustoOperacao                   float64   `translator:"part:78..89;decimal:2"`          // Valor do Custo da Operação          079..090 N(012)
	ValorLiquidoOperacao                 float64   `translator:"part:90..101;decimal:2"`         // Valor Líquido da Operação           091..102 N(012)
	TaxaMensalOperacao                   float64   `translator:"part:102..112;decimal:7"`        // Taxa Mensal da Operação (%)         103..113 N(011)
...
type DetalheFinanceiro struct {
	...
	ValorLiquidoURNegociada            float64   `translator:"part:86..97;decimal:2"`          // Valor Líquido da UR Negociada        087..098 N(012)
	ValorCustoURNegociada              float64   `translator:"part:98..109;decimal:2"`         // Valor do Custo da UR Negociada       099..110 N(012)
	ValorBrutoURNegociada              float64   `translator:"part:110..121;decimal:2"`        // Valor Bruto da UR Negociada          111..122 N(012)
