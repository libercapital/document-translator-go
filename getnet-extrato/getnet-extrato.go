...
type ResumoTransacional struct {
	...
	ValorBruto                         decimal.Decimal `translator:"part:84..95;precision:2"`          // Valor Bruto                           085..096 N(012)
	ValorLiquido                       decimal.Decimal `translator:"part:96..107;precision:2"`         // Valor Líquido                         097..108 N(012)
	ValorTarifa                        decimal.Decimal `translator:"part:108..119;precision:2"`        // Valor da Tarifa                       109..120 N(012)
	ValorTaxaDesconto                  decimal.Decimal `translator:"part:120..131;precision:2"`        // Valor da Taxa de Desconto             121..132 N(012)
	ValorRejeitado                     decimal.Decimal `translator:"part:132..143;precision:2"`        // Valor Rejeitado                       133..144 N(012)
	ValorCredito                       decimal.Decimal `translator:"part:144..155;precision:2"`        // Valor Crédito                         145..156 N(012)
	...
	ValorLiquidoCobranca               decimal.Decimal `translator:"part:254..265;precision:2"`        // Valor Líquido da Cobrança             255..266 N(012)
...
type AnaliticoTransacional struct {
	...
	ValorTransacao                     decimal.Decimal `translator:"part:70..81;precision:2"`          // Valor da Transação                    071..082 N(012)
	ValorSaque                         decimal.Decimal `translator:"part:82..93;precision:2"`          // Valor do Saque                        083..094 N(012)
	ValorTaxaEmbarque                  decimal.Decimal `translator:"part:94..105;precision:2"`         // Valor da Taxa de Embarque             095..106 N(012)
	...
	ValorParcela                       decimal.Decimal `translator:"part:110..121;precision:2"`        // Valor da Parcela                      111..122 N(012)
	...
	ValorComissaoVenda                 decimal.Decimal `translator:"part:175..186;precision:2"`        // Valor Comissão da Venda               176..187 N(012)
...
type AjusteFinanceiro struct {
	...
	ValorAjuste                    decimal.Decimal `translator:"part:63..74;precision:2"`          // Valor do Ajuste                      064..075 N(012)
	...
	ValorComissaoVendaCancelada    decimal.Decimal `translator:"part:154..165;precision:2"`        // Valor da Comissão da Venda Cancelada 155..166 N(012)
...
type ResumoFinanceiro struct {
	...
	ValorBrutoOperacaoAdquirencia        decimal.Decimal `translator:"part:66..77;precision:2"`        // Valor Bruto da Operação - Adquirência 067..078 N(012)
	ValorCustoOperacao                   decimal.Decimal `translator:"part:78..89;precision:2"`        // Valor do Custo da Operação          079..090 N(012)
	ValorLiquidoOperacao                 decimal.Decimal `translator:"part:90..101;precision:2"`       // Valor Líquido da Operação           091..102 N(012)
	TaxaMensalOperacao                   decimal.Decimal `translator:"part:102..112;precision:7"`      // Taxa Mensal da Operação (%)         103..113 N(011)
...
type DetalheFinanceiro struct {
	...
	ValorLiquidoURNegociada            decimal.Decimal `translator:"part:86..97;precision:2"`        // Valor Líquido da UR Negociada        087..098 N(012)
	ValorCustoURNegociada              decimal.Decimal `translator:"part:98..109;precision:2"`       // Valor do Custo da UR Negociada       099..110 N(012)
	ValorBrutoURNegociada              decimal.Decimal `translator:"part:110..121;precision:2"`      // Valor Bruto da UR Negociada          111..122 N(012)
