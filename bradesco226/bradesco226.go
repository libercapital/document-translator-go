...
type Header struct {
	...
	MovementDate           string `translator:"part:10..17"`      // Data do movimento                                  011..018 9(008)
...
type Contract struct {
	...
	Installments                  uint16          `translator:"part:98..100"`                   // Quantidade de Parcelas                   099..101 9(003)
	...
	EconomicIndex                 uint64          `translator:"part:151..155"`                  // Indice Econômico                         152..156 9(005)
	...
	FloatRate                     uint64          `translator:"part:169..170"`                  // Float (Zeros)                            170..171 9(002)
...
type Borrower struct {
	...
	ContractNumber         string `translator:"part:1..9"`        // Numero do contrato                         002..010 9(009)
	PersonType             string `translator:"part:10..0"`       // Tipo de Pessoa - 1 p/ PF 2 p/PJ            011..011 9(001)
...
type Installment struct {
	...
	ContractNumber              string          `translator:"part:1..9"`                      // Numero do contrato                       002..010 9(009)
	InstallmentNumber           uint16          `translator:"part:10..12"`                    // Numero da parcela                        011..013 9(003)
	...
	PostDatedCheckBank          string          `translator:"part:49..51"`                    // Banco do cheque pré-datado               050..052 9(003)
	PostDatedCheckBranch        string          `translator:"part:52..56"`                    // Agência do cheque pré-datado             053..057 9(005)
	PostDatedCheckAccountNumber string          `translator:"part:57..67"`                    // Conta do cheque pré-datado               058..068 9(011)
	PostDatedCheckNumber        string          `translator:"part:68..74"`                    // Numero do cheque pré-datado              069..075 9(007)
