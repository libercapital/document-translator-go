...
type BillingSegmentA struct {
	...
	ReferenceNumberPrefix string          `translator:"part:201..229;prefixFrom:PS,PA,SP,SA,EN,DM"` //Numero de referência                    202..230   X(029)
	ReferenceNumber       string          `translator:"part:201..229;splitAfter:PS,PA,SP,SA,EN,DM"` //Numero de referência                    202..230   X(029)
